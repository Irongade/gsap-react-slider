...
function App() {
  ...
  useEffect(() => {
    console.log(imageList, gsap)
    gsap.to(testimonialsList.children[0], {duration: 0, opacity: 1})
  }, [])
  ...
  const fadeOut = (index, duration) => {
    gsap.to(testimonialsList.children[index], {
      duration: duration,
      opacity: 0,
      ease: "power3.out()"
    })
